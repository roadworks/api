...
elginItems.xsd 
- Main XSD schema file containing definitions of each element.  
Please see Entities and Items as parent elements

elginTypes.xsd
- included by elginItems.xsd containing all supporting types
